...
#ifndef D3D12_TEXT_H_INCLUDED
#define D3D12_TEXT_H_INCLUDED
...
static ID3D12PipelineState* textPSO; // pso containing a pipeline state

static Font arialFont; // this will store our arial font information

static int maxNumTextCharacters = 1024; // the maximum number of characters you can render during a frame. This is just used to make sure
// there is enough memory allocated for the text vertex buffer each frame

static ID3D12Resource* textVertexBuffer[3];
static D3D12_VERTEX_BUFFER_VIEW textVertexBufferView[3]; // a view for our text vertex buffer
static UINT8* textVBGPUAddress[3]; // this is a pointer to each of the text constant buffers

// create an instance of timer
static Helpers::Timer timer;
