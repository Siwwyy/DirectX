...
void D3D12App::InitializePSO()
{
...

	{
		...
		D3D12_DESCRIPTOR_RANGE DescriptorTableRanges[1] = { DescriptorRange };
		const auto DescriptorTable = CreateRootDescriptorTable(_countof(DescriptorTableRanges), DescriptorTableRanges);
...
// TODO | TO REFACTOR EVERYTHING BELOW
